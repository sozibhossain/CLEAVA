          ...
          <View style={styles.heroContent}>
            <View style={styles.heroText}>
              ...
              <Text style={styles.heroDescription}>
                Let us clean! We take care of cleaning your apartment professionally, so you&apos;ll
                have more time.
              </Text>
              <TouchableOpacity
        ...
        <View style={styles.testimonialSection}>
          ...
          <View style={styles.testimonialCard}>
            ...
            <Text style={styles.testimonialText}>
              Wir wollten uns bei Ihnen und Ihrer Mitarbeiterin sehr herzlich für die
              Reinigungsarbeit bedanken. Ihre Mitarbeiterin hat eine exzellente Arbeit geleistet und
              wir sind hochzufrieden. Sie haben ein ausgezeichnetes Personal.
            </Text>
            <Text style={styles.testimonialAuthor}>
              Zufriedener Kunde, Unsere Kundenstimmen ansehen
            </Text>
          </View>
        </View>
